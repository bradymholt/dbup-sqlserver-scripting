...
public class DefinitionScriptProvider : IScriptProvider
{
    ...
    private Script DiscoverDependants(
        IEnumerable<Script> source,
        Script leaf
        )
    {
    ...
    private IEnumerable<Script> WalkDependencies(
        List<Script> scripts
        )
    {
    ...
    class Script
    {
        ...
        public string CompareName => string.Join(".",
            Name.Split(new[] { "." }, StringSplitOptions.RemoveEmptyEntries).Select(y => $"[{y}]"));

        public string Contents { get; set; }
        public IEnumerable<Script> Dependencies { get; private set; }

        public void SetDependencies(
            IEnumerable<Script> dependencies
            )
        {
